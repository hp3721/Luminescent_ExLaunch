...
HOOK_DEFINE_TRAMPOLINE(GetSetting) {
    static int32_t Callback(DPData::CONFIG::Object* __this, int32_t id) {
        switch (id) {
            case 14:
                return FlagWork::GetFlag(FLAG_AFFECTION_ENABLED) ? 1 : 0;
            case 15:
                return FlagWork::GetFlag(FLAG_UNOVA_SOUNDS) ? 1 : 0;
            case 16:
                return FlagWork::GetFlag(FLAG_KALOS_SOUNDS) ? 1 : 0;
            default:
    ...
    static void Callback(DPData::CONFIG::Object* __this, int32_t id, int32_t value) {
        switch (id) {
            case 14:
                ...
                break;
            case 15:
                FlagWork::SetFlag(FLAG_UNOVA_SOUNDS, value);
                break;
            case 16:
                FlagWork::SetFlag(FLAG_KALOS_SOUNDS, value);
                break;
            default:
...
HOOK_DEFINE_TRAMPOLINE(AddSettingsEntries) {
    static bool Callback(Dpr::UI::SettingWindow::_OpOpen_d__11::Object* __this) {
        ...
        AddSetting(__this, 14, FlagWork::GetFlag(FLAG_AFFECTION_ENABLED) ? 1 : 0, "SS_option_110", "SS_option_113", onOffNames, 1);
        AddSetting(__this, 15, FlagWork::GetFlag(FLAG_UNOVA_SOUNDS) ? 1 : 0, "SS_option_109", "SS_option_112", onOffNames, 2);
        AddSetting(__this, 16, FlagWork::GetFlag(FLAG_KALOS_SOUNDS) ? 1 : 0, "SS_option_111", "SS_option_114", onOffNames, 3);
